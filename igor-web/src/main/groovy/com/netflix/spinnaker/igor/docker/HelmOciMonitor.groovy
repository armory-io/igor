...
import com.netflix.spinnaker.igor.docker.service.TaggedCharts
...
class HelmOciMonitor extends CommonPollingMonitor<ImageDelta, DockerPollingDelta> {
    ...
    DockerPollingDelta generateDelta(PollContext ctx) {
        ...
        List<TaggedCharts> images = AuthenticatedRequest.allowAnonymous { dockerRegistryAccounts.service.getChartsByAccount(account, true) }
        ...
        images.findAll { it != null }.forEach { TaggedCharts image ->
    ...
    private UpdateType getUpdateType(Set<String> cachedImages, String imageId, TaggedCharts image, boolean trackDigests) {
    ...
    void postEvent(Set<String> cachedImagesForAccount, TaggedCharts image, String imageId) {
